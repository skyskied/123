...
print(f"vgg16 对比实验引擎启动，使用设备: {DEVICE}")
...
def main():
    ...
    print("⏳ 正在构建 vgg16 模型...")
    model = create_model("vgg16", pretrained=True, num_classes=4)
    ...
    print(f"开始训练 vgg16，共计 {EPOCHS} 个 Epoch...")
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_acc:
            ...
            print("  发现最佳模型！权重保存为 vgg16_best.pth")
